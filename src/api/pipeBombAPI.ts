...
export const useSearchLibrary = <TError = void, TContext = unknown>(options?: {
	mutation?: UseMutationOptions<
		Awaited<ReturnType<typeof searchLibrary>>,
		TError,
		{ pluginId: string; libraryId: string; data: LibrarySearchDto },
	...
	TContext
> => {
	return useMutation(getSearchLibraryMutationOptions(options));
};
...
export const useStartTask = <TError = void, TContext = unknown>(options?: {
	mutation?: UseMutationOptions<
		Awaited<ReturnType<typeof startTask>>,
		TError,
		{ taskUuid: string },
...
>(
	...
	return {
		queryKey,
		queryFn,
		enabled: artistUuid !== null && artistUuid !== undefined,
		...queryOptions,
...
>(options?: {
	...
	TContext
> => {
	return useMutation(getSearchArtistsMutationOptions(options));
};
...
>(options?: {
	...
	TContext
> => {
	return useMutation(getSetAttributeSourceOrderMutationOptions(options));
};
...
>(
	...
	return {
		...
		queryFn,
		enabled:
			dir !== null && dir !== undefined && file !== null && file !== undefined,
		...queryOptions,
...
>(
	...
	iconId: string,
	options?: {
		query?: UseQueryOptions<Awaited<ReturnType<typeof getIcon>>, TError, TData>;
		request?: SecondParameter<typeof customFetch>;
	},
) => {
	const { query: queryOptions, request: requestOptions } = options ?? {};
...
>(
	...
	return {
		queryKey,
		queryFn,
		enabled: albumUuid !== null && albumUuid !== undefined,
		...queryOptions,
...
>(options?: {
	...
	TContext
> => {
	return useMutation(getSearchAlbumsMutationOptions(options));
};
...
>(
	...
	return {
		queryKey,
		queryFn,
		enabled: languageId !== null && languageId !== undefined,
		...queryOptions,
	} as UseQueryOptions<
		Awaited<ReturnType<typeof getLanguageMap>>,
		TError,
...
>(
	...
	return {
		queryKey,
		queryFn,
		enabled: pluginId !== null && pluginId !== undefined,
		...queryOptions,
	} as UseQueryOptions<
		Awaited<ReturnType<typeof getPluginConfig>>,
		TError,
...
>(options?: {
	...
	TContext
> => {
	return useMutation(getUpdatePluginConfigMutationOptions(options));
};
...
export const getGetJsonQueryOptions = <
	...
	TError = unknown,
>(options?: {
	query?: UseQueryOptions<Awaited<ReturnType<typeof getJson>>, TError, TData>;
	request?: SecondParameter<typeof customFetch>;
}) => {
	const { query: queryOptions, request: requestOptions } = options ?? {};
